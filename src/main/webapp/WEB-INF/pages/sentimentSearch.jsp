...
<h1>Flickr sentiment</h1>

<div class="innerContent pull-left span3">
  <spring:url value="/flickr/sentiment" var="searchURL" htmlEscape="true"/>

  <h4>Search:</h4>

  <form:form action="${searchURL}" method='POST' modelAttribute="sentimentSearchData">
    ...
    <section class="">
      <div class="form-group">
        <label>One or more keywords (comma separated):</label>
        <form:input path="keywords" size="100" class="span3"/>
        <label>Number of photos (more than 0):</label>
        <form:input path="numOfPhotos" size="20" class="span3"/>
      </div>
      <%--<div class="form-group">--%>
        <%--<label>Views:</label>--%>
    ...
    <form:button type="submit" class="btn btn-block btn-success">Search</form:button>
  </form:form>
