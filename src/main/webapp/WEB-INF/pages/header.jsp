...
<html>
	<head>
		...
		<title>MI-VMW project: Flickr metadata reranking</title>
		<link rel="stylesheet" media="all" type="text/css" href="<c:url value="/WEB-INF/resources/css/bootstrap.min.css" />" />
