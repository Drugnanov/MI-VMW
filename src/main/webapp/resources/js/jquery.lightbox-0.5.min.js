...
(function ($) {
  $.fn.lightBox = function (settings) {
    settings = jQuery.extend({
      ...
      imageLoading: '/semestralka/resources/images/lightbox-ico-loading.gif',
      imageBtnPrev: '/semestralka/resources/images/lightbox-btn-prev.gif',
      imageBtnNext: '/semestralka/resources/lightbox-btn-next.gif',
      imageBtnClose: '/semestralka/resources/images/lightbox-btn-close.gif',
      imageBlank: '/semestralka/resources/lightbox-blank.gif',
    ...
    function _resize_container_image_box(intImageWidth, intImageHeight) {
      ...
      $('#lightbox-container-image-box').animate({width: intWidth, height: intHeight}, settings.containerResizeSpeed,
    ...
    function _show_image_data() {
      ...
      if (settings.imageArray.length > 1) {
        $('#lightbox-image-details-currentNumber').html(settings.txtImage + ' ' + (settings.activeImage + 1) + ' ' +
