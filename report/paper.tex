...
\subsection{Knihovny}
\todo{dodělat ("učesat") Implementaci}
...
\todo{Něco do expreimentální sekce? V zadání je, že bychom mohli měřit dobu běhu (kolik zabere reranking vs. api)}
...
\todo{Závěr - něco k implementaci? Napsat ja parádně naše aplikace funguje?}
